...
--All credits belongs to Benik for this SpecSwitch datatext mod
...
DT:RegisterDatatext('Spec Switch (SFUI)',{"PLAYER_ENTERING_WORLD", "CHARACTER_POINTS_CHANGED", "PLAYER_TALENT_UPDATE", "ACTIVE_TALENT_GROUP_CHANGED"}, OnEvent, nil, OnClick, OnEnter)