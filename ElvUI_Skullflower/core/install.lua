...
local SFUI = E:NewModule('Skullflower', 'AceHook-3.0', 'AceEvent-3.0');

local CURRENT_PAGE = 0
local MAX_PAGE = 2

-- GLOBALS:
SFUI.ClassColor = E.myclass == "PRIEST" and E.PriestColors or (CUSTOM_CLASS_COLORS and CUSTOM_CLASS_COLORS[E.myclass] or RAID_CLASS_COLORS[E.myclass])
...
function SFUI:GetClassColorString(class)
	local color = SFUI.colors.class[BC[class] or class]
...
--Default Chat settings from the ElvUI installer, with some added modifications
...
--Default CVars settings from the ElvUI installer with some added modifications
...
function E:SetupTheme(theme, noDisplayMsg)
	...
	if not E.db.movers then E.db.movers = {}; end
		...
		E.db.movers["ZoneAbility"] = "BOTTOM,ElvUIParent,BOTTOM,0,140"
		E.db.movers["VehicleSeatMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,30,-30"
		E.db.movers["AzeriteBarMover"] = "BOTTOM,ElvUIParent,BOTTOM,0,100"
		E.db.movers["ReputationBarMover"] = "TOP,ElvUIParent,TOP,0,-34"
		E.db.movers["HonorBarMover"] = "TOP,ElvUIParent,TOP,0,-67"
		...
		E.db.movers["BNETMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,30,206"
		E.db.movers["GMMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,30,-30"
		if IsAddOnLoaded('Skada') then
		E.db.movers["TooltipMover"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-29,213"
		else
		E.db.movers["TooltipMover"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-29,168"
		end
		...
		E.db.general.backdropfadecolor = {r = 18/255, g = 18/255, b = 18/255, a = 0.85}
		...
		E.db.databars.azerite.width = 395
		E.db.databars.azerite.height = 32
	...
	E.db["nameplates"]["colors"]["glowColor"] = {r = 251/255, g = 79/255, b = 79/255, a = 1}
	...
	E.db["nameplates"]["units"]["ENEMY_NPC"]["questIcon"]["yOffset"] = 0
		...
		elseif theme == "HealerLayout" then
			E.db.movers["BossButton"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,380,270"
			E.db.movers["ZoneAbility"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,380,270"
			E.db.movers["AzeriteBarMover"] = "TOP,ElvUIParent,TOP,0,-100"
		...
		--Group movers
			E.db.movers["ElvUF_PartyMover"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,708,200"
			E.db.movers["ElvUF_RaidMover"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,756,385"
			E.db.movers["ElvUF_Raid40Mover"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,756,389"
		...
		elseif theme == "BoxedFrames" then
			E.db.movers["BossButton"] = "BOTTOM,ElvUIParent,BOTTOM,0,140"
			E.db.movers["ZoneAbility"] = "BOTTOM,ElvUIParent,BOTTOM,0,140"
			E.db.movers["BNETMover"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-30,206"
			E.db.movers["AzeriteBarMover"] = "BOTTOM,ElvUIParent,BOTTOM,0,100"
		...
		elseif theme == "extraActionBars" then
			E.db.movers["AzeriteBarMover"] = "BOTTOM,ElvUIParent,BOTTOM,0,133"
			E.db.movers["BossButton"] = "BOTTOM,ElvUIParent,BOTTOM,0,170"
			E.db.movers["ZoneAbility"] = "BOTTOM,ElvUIParent,BOTTOM,0,170"
		...
		elseif theme == "squareBars" then
			...
			E.db.movers["AzeriteBarMover"] = "TOP,ElvUIParent,TOP,0,-99"
		...
		elseif theme == "Databars" then
			...
			E.db.movers["AzeriteBarMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-30,-205"
		...
		-- Datatexts Minimap
		elseif theme == "DTexts MM" then
			E.db.movers["SquareMinimapButtonBarMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-30,-204"
			E.db.movers["SquareMinimapBar"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-30,-204"
			E.db.datatexts.minimapPanels = true
			E.db.datatexts.panels.LeftMiniPanel = "Friends"
		...
		elseif theme == "enableAuraBars" then
			...
			E.db.unitframe.units.player.aurabar.yOffset = 18
			end
			E.db.unitframe.units.target.aurabar.attachTo = "FRAME"
			E.db.unitframe.units.target.aurabar.anchorPoint = "ABOVE"
		...
		elseif theme == "UFTexts" then
			...
			E.db.unitframe.units.target.customTexts.NameText.text_format = "[name:long]"
			E.db.unitframe.units.target.power.text_format = "[health:percent-sfui]"
			E.db.unitframe.units.targettarget.name.text_format = "[name:medium]"
			E.db.unitframe.units.focus.name.text_format = "[name:medium]"
			E.db.unitframe.units.focustarget.name.text_format = "[name:medium]"
			E.db.unitframe.units.pet.name.text_format = "[name:medium]"
			E.db.unitframe.units.party.health.text_format = "[health:deficit-sfui]"
			E.db.unitframe.units.raid.health.text_format = "[health:deficit-sfui]"	
			E.db.unitframe.units.raid40.health.text_format = "[health:deficit-sfui]"
...
function E:SetupAddon(addon)
	if addon == 'Skada' then
		if IsAddOnLoaded('Skada') then
			E:Print(L["A profile for Skada has been created and applied."])
		...
		Skada.db:SetProfile("Skullflower")
	end

	if IsAddOnLoaded('Details') then
		E:Print(L["A profile for Details! has been created and applied."])
		InstallStepComplete.message = L["AddOn Profiles installed"]
		InstallStepComplete:Show()
	...
	if IsAddOnLoaded('Recount') then
		E:Print(L["A profile for Recount has been created and applied."])
		InstallStepComplete.message = L["AddOn Profiles installed"]
		InstallStepComplete:Show()
		RecountDB['profiles']['Skullflower'] = {
		['Colors'] = {
			['Other Windows'] = {
				['Title Text'] = {
					['g'] = 0.70,
		...
		['BarTexture'] = 'Skullflower',
		['CurDataSet'] = 'CurrentFight',
		['ClampToScreen'] = true,
		['Font'] = 'Expressway',
	}
	Recount.db:SetProfile("Skullflower")
	end

	if IsAddOnLoaded('BigWigs') then
		E:Print(L["A profile for Big Wigs has been created and applied."])
		InstallStepComplete.message = L["AddOn Profiles installed"]
		InstallStepComplete:Show()
		BigWigs3DB = {
		["namespaces"] = {
		...
		["BigWigs_Plugins_Messages"] = {
			["profiles"] = {
				...
				["Skullflower"] = {
					...
					["growUpwards"] = false,
					["font"] = "Expressway",
					["BWMessageAnchor_y"] = 560,
					["BWEmphasizeMessageAnchor_y"] = 640,
					["BWEmphasizeMessageAnchor_x"] = 608,
				},
			},
		},
	...
	if IsAddOnLoaded('DBM-Core') then
		...
		E:Print(L["A profile for DBM has been created and applied."])
		InstallStepComplete.message = L["AddOn Profiles installed"]
		InstallStepComplete:Show()
	...
	if (IsAddOnLoaded('ProjectAzilroka') and _G.ProjectAzilroka.db['SMB']) then
		E:Print(L["A profile for Square Minimap Buttons has been created and applied."])
		InstallStepComplete.message = L["AddOn profiles installed"]
		InstallStepComplete:Show()
		if SquareMinimapButtonsDB["profiles"]["Skullflower"] == nil then SquareMinimapButtonsDB["profiles"]["Skullflower"] = {} end
		E.db["movers"]["SquareMinimapButtonBarMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-30,-183"
		SquareMinimapButtonsDB.profiles["Skullflower"] = {
			['BarEnabled'] = true,
			['ButtonsPerRow'] = 6,
			['IconSize'] = 24,
			['ButtonSpacing'] = 1,
		}
		local db = LibStub("AceDB-3.0"):New(SquareMinimapButtonsDB)
		db:SetProfile("Skullflower")
		end
	
	if (IsAddOnLoaded('ProjectAzilroka') and _G.ProjectAzilroka.db['EFL']) then
		E:Print(L["A profile for Enhanced Friends List has been created and applied."])
		InstallStepComplete.message = L["AddOn profiles installed"]
		InstallStepComplete:Show()
		if EnhancedFriendsListDB["profiles"]["Skullflower"] == nil then EnhancedFriendsListDB["profiles"]["Skullflower"] = {} end
		EnhancedFriendsListDB.profiles["Skullflower"] = {
			["NameFont"] = "Expressway",
			["NameFontSize"] = 11,
		...
		local db = LibStub("AceDB-3.0"):New(EnhancedFriendsListDB)
		db:SetProfile("Skullflower")
	end

	if (IsAddOnLoaded('ProjectAzilroka') and _G.ProjectAzilroka.db['stAM']) then
		E:Print(L["A profile for stAddonManager has been created and applied."])
		InstallStepComplete.message = L["AddOn profiles installed"]
		InstallStepComplete:Show()
		if stAddonManagerDB["profiles"]["Skullflower"] == nil then stAddonManagerDB["profiles"]["Skullflower"] = {} end
		stAddonManagerDB.profiles["Skullflower"] = {
			['NumAddOns'] = 30,
			["ButtonHeight"] = 20,
			["ButtonWidth"] = 20,
			["Font"] = "Expressway",
	...
	if IsAddOnLoaded('ElvUI_SLE') then
		E:Print(L["A profile for Shadow & Light has been created and applied."])
		InstallStepComplete.message = L["AddOn profiles installed"]
		InstallStepComplete:Show()
	...
	if IsAddOnLoaded('XIV_Databar') then
		E:Print(L["A profile for XIV_Databar has been created and applied."])
		InstallStepComplete.message = L["AddOn profiles installed"]
		InstallStepComplete:Show()
		XIVBarDB = {
			["profiles"] = {
	...
	if IsAddOnLoaded('ElvUI_VisualAuraTimers') then
		E:Print(L["A profile for Visual Aura Timers has been created and applied."])
		InstallStepComplete.message = L["AddOn profiles installed"]
		InstallStepComplete:Show()
	...
	if IsAddOnLoaded('ElvUI_EverySecondCounts') then
		E:Print(L["A profile for Every Second Counts has been created and applied."])
		InstallStepComplete.message = L["AddOn profiles installed"]
		InstallStepComplete:Show()
	...
	if IsAddOnLoaded('ls_Toasts') and IsAddOnLoaded('ls_Toasts_Rehok') then
		E:Print(L["A profile for Is_Toasts has been created and applied."])
		InstallStepComplete.message = L["AddOn profiles installed"]
		InstallStepComplete:Show()
		LS_TOASTS_GLOBAL_CONFIG["profiles"]["Skullflower"]  = {
			["point"] = {
				["rP"] = "TOP",
				["p"] = "TOP",
				["y"] = -150,
	...
	if IsAddOnLoaded('MaxCam') then
		E:Print(L["A profile for MaxCam has been created and applied."])
		InstallStepComplete.message = L["AddOn profiles installed"]
		InstallStepComplete:Show()
		MaxCamDB = {
		["speed"] = 50,
	...
	if IsAddOnLoaded('NameplateSCT') then
		E:Print(L["A profile for NameplateSCT has been created and applied."])
		InstallStepComplete.message = L["AddOn profiles installed"]
		InstallStepComplete:Show()
		NameplateSCTDB = {
		["global"] = {
	...
	if IsAddOnLoaded('CompactRunes') then
		E:Print(L["A profile for CompactRunes has been created and applied."])
		InstallStepComplete.message = L["AddOn Profiles installed"]
		InstallStepComplete:Show()
		...
		local db = LibStub("AceDB-3.0"):New(CompactRunesDB, nil, true)
		db:SetProfile("Skullflower")
		end
	end
end
...
local function ResetAll()
	...
	ChatBtn:SetText('')
	CvarsBtn:Hide()
	CvarsBtn:SetScript('OnClick', nil)
	CvarsBtn:SetText('')
...
local function SetPage(PageNum)
	...
	if PageNum == 1 then
		InstallBtn:Show()
		InstallBtn:SetScript('OnClick', function() E:SetupTheme('SkullflowerUI'); SetProfilesToSkullflower() end)
		InstallBtn:SetText(L['UI Installed'])	
		...
		ChatBtn:Show()
		ChatBtn:SetScript("OnClick", function() SetupChat() end)
		ChatBtn:SetText(L[''])
		
		CvarsBtn:Show()
		CvarsBtn:SetScript("OnClick", function() SetupCVars() end)
		CvarsBtn:SetText(L[''])
	...
	elseif PageNum == 2 then
		...
		InstallOption7Button:SetText(L['|cffffffffBoxed UFrames|r'])
		
		InstallOption8Button:Show()
		InstallOption8Button:SetScript('OnClick', function() E:SetupTheme('VerticalFrames') end)
		InstallOption8Button:SetText(L['|cffffffffVertical UFrames|r'])
		...
		InstallOption10Button:SetText(L['|cffffffffEnable AuraBars|r'])
		...
		InstallOption14Button:SetScript('OnClick', function() E:SetupTheme('DTexts Chat') end)
		InstallOption14Button:SetText(L['|cffffffffDTexts Chat|r'])
		
		InstallOption15Button:Show()
		InstallOption15Button:SetScript('OnClick', function() E:SetupTheme('DTexts MM') end)
		InstallOption15Button:SetText(L['|cffffffffDTexts Minimap|r'])
	end
end
...
function E:Install()	
	...
	if not ElvUIInstallFrame then
		...
		f.AddonsBtn:Point('RIGHT', f.Next, 64, 0)
		f.AddonsBtn:SetText("")
		f.AddonsBtn:SetAlpha(0)
		...
		f.MoveBtn:Point('RIGHT', f.AddonsBtn, 64, 0)
		f.MoveBtn:SetText("")
		...
		f.ChatBtn:Point('RIGHT', f.MoveBtn, 64, 0)
		f.ChatBtn:SetText("")
		f.ChatBtn:SetAlpha(0)
		E.Skins:HandleButton(f.ChatBtn, true)
		
		f.CvarsBtn = CreateFrame("Button", "CvarsBtn", f, "UIPanelButtonTemplate")
		f.CvarsBtn:StripTextures()
		f.CvarsBtn:SetFrameStrata('MEDIUM')
		f.CvarsBtn:Size(64, 64)
		f.CvarsBtn:Point('RIGHT', f.ChatBtn, 64, 0)
		f.CvarsBtn:SetText("")
		f.CvarsBtn:SetAlpha(0)
		E.Skins:HandleButton(f.CvarsBtn, true)
		...
		f.FinishBtn:Point('RIGHT', f.CvarsBtn, 64, 0)
		f.FinishBtn:SetText("")
		...
		f.Option1:SetFrameStrata('HIGH')
		f.Option1:Size(100, 20)
		...
		f.Option2:SetFrameStrata('HIGH')
		f.Option2:Size(100, 20)
		...
		f.Option3:SetFrameStrata('HIGH')
		f.Option3:Size(100, 20)
		...
		f.Option4:SetFrameStrata('HIGH')
		f.Option4:Size(100, 20)
		...
		f.Option5:SetFrameStrata('HIGH')
		f.Option5:Size(100, 20)
		...
		f.Option6:SetFrameStrata('HIGH')
		f.Option6:Size(100, 20)
		...
		f.Option7:SetFrameStrata('HIGH')
		f.Option7:Size(100, 20)
		...
		f.Option8:SetFrameStrata('HIGH')
		f.Option8:Size(100, 20)
		...
		f.Option9:SetFrameStrata('HIGH')
		f.Option9:Size(100, 20)
		...
		f.Option10:SetFrameStrata('HIGH')
		f.Option10:Size(100, 20)
		...
		f.Option11:SetFrameStrata('HIGH')
		f.Option11:Size(100, 20)
		...
		f.Option12:SetFrameStrata('HIGH')
		f.Option12:Size(100, 20)
		...
		f.Option13:SetFrameStrata('HIGH')
		f.Option13:Size(100, 20)
		...
		f.Option14:SetFrameStrata('HIGH')
		f.Option14:Size(100, 20)
		...
		f.Option15:SetFrameStrata('HIGH')
		f.Option15:Size(100, 20)
		f.Option15:SetAlpha(1)
		...
		f.SUF:Point('LEFT', "ElvUIInstallFrame", 128, -75)
		...
		f.AddonsBtn:Point('RIGHT', f.CustomBtn, 64, 0)
		...
		f.CvarsBtn = f:CreateTexture('ChatButton')
		f.CvarsBtn:SetTexture('Interface\\AddOns\\ElvUI_Skullflower\\media\\textures\\cvars.tga')
		f.CvarsBtn:Point('RIGHT', f.ChatBtn, 64, 0)
