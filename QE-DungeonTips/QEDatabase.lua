...
tipsMap = {
	...
	[164567] = {{"Important", "Focus Droman first to 20%. Feel free to cleave Ingra, especially if it's a single target DPS increase."},
				...
				{"Important", "DODGE: The blue frontal beam and the purple swirls"},
				{"HEALER", "Make sure you contribute damage to the burst phase. Every bit counts and incoming dmg is low."}}, -- Ingra Maloch
	[170217] = {{"Important", "Minigame is at 70, 40 and 10%. You'll need to kill the illusion that stands out from the others in Shape, Circle, or Opacity."},
				...
				{"Important", "If the white fox touches you, it'll AoE freeze. You can CC it, and of course kite it."}}, -- Mistcaller
	...
	[164517] = {{"Important", "Mind Link: Quickly spread out to break the chains."},
				...
				{"Important", "Dodge: green and blue swirls. The green stuff on the floor from Larva deaths."}}, -- Tred'ova
	...
	[164804] = {{"Important", "Minigame is at 70, 40 and 10%. You'll need to kill the illusion that stands out from the others in Shape, Circle, or Opacity."},
				{"Important", "Shape: Leaf vs Flower. Opacity: Shapes can either be 'filled in' or 'clear'. Circle is self explanatory."},
				{"Important", "Save your cooldowns for 10% and you can burst her down before the third mini-game."},
				{"Important", "Interrupt(!!!): Patty Cake. Will chop the tank in half. MUST be interrupted by the tank themselves."},
				{"Important", "If the white fox touches you, it'll AoE freeze. You can CC it, and of course kite it."}}, -- Droman Oulfarran
	...
	[164920] = {{"Important", "Dispel: Soul Split (Increased Damage Taken)"}, {"Tank", "The mob will buff itself with Hand of Thros, ideally kite it during this time to prevent it self-healing."}}, -- Drust Soulcleaver
	...
	[164929] = {{"Important", "LARGE FRONTAL CONE. Basically a big blue kamehameha that will disorient you."}, {"Important", "Will cocoon a random player. Break it with damage."}, {"Important", "Becomes friendly at 20% and heals / restores mana"}, {"HEALER", "The disorient is dispellable because we both know at least one DPS is walking into it"}}, -- Tirnenn Villager
	[164921] = {{"Interrupt", "Interrupt(!): Harvest Essence (AoE Channel + Heal"}}, -- Drust Harvester
	[167117] = {{"Important", "Drops an acid pool on death."}}, -- Spinemaw Larva
	...
	[169905] = {{"Important", "Soothe: Undying Rage (Unkillable + huge dmg inc)"},
				{"Important", "Dodge the giant red whirlwind. Scary."}}, -- Risen Warlord
	...
	[164556] = {{"Important", "Intercept the beams that fire from Crystals around the room. They give dmg buff."},
				...
				{"Important", "Move from the laser after the initial hit fires to dodge the stun."}}, -- Millhouse Manastorm
	...
	[168992] = {{"Important", "Dodge the little purple flowers. You can also stun the cast (Dark Lotus)."}}, -- Risen Cultist
	[164857] = {{"Important", ""}}, -- Spriggan Mendbender
	[168949] = {{"Important", ""}}, -- Risen Bonesoldier
	...
	[162102] = {{"Important", "During Rite of Supremacy: soak 3-4 yellow orbs. Pop a defensive if you come up short."},
				{"Important", "Dodge the big yellow swirls. These really hurt."},
	...
	[162057] = {{"Important", "DANGEROUS frontal cone bleed. Face away from party."},
				{"Important", "Dodge: The brown swirls will knock you up."},
	...
	[171376] = {{"Important", "Dodge: the big tornado. It's speedy."},
	...
	[162047] = {{"Important", "Dodge: blue swirl. Will heal the boss if hit."}}, -- Insatiable Brute
	[171384] = {{"Important", "Dodge: the big fire swirls."}}, -- Research Scribe
	...
	[171805] = {{"Important", "Dodge: the big fire swirls."}}, -- Research Scribe
	...
	----- Halls of Atonement -----
	[164218] = {{"Important", "Will throw statues. Statues face the direction they're going to fly and can be dodged."},
	...
	[164557] = {{"Important", "Thrash is a large AoE damage ability. If your group is low it can be outranged."},
	...
	[164255] = {{"Important", "Slive Wave: Large cone at random player. Stay close to boss to dodge."},
	...
	[163894] = {{"Important", "FRONTAL CONE: Festering Belch (tank can dodge after cast start"}}, -- Blighted Spinebreaker
	...
	[165946] = {{"Important", "Most Dangerous: Sub 50% health boss spawns ghost horses that will run across the room."},
				...
				{"Important", "Dodge: The big black beam. The soldiers that fight in swirls in the middle of the room."},
	...
	[162317] = {{"Important", "Try and stay in the center of the room to dodge the wall of hooks."},
	...
	[170882] = {{"Interrupts", "Stun Interrupt (!): Bone Spear (big bleed)"}}, -- Bone Magus
	[165260] = {{"Important", ""}}, -- Oozing Leftovers
	[169875] = {{"Important", ""}}, -- Shackled Soul
	...
	[163157] = {{"Important", "Focus down adds so that they're dead before Final Harvest."},
				...
				{"Important", "Dodge: Breath ability. Will rotate in one direction."}}, -- Amarth
	...
	[162689] = {{"Important", "The add will cast Meat Hook which needs to be aimed at the boss to grip him down."},
				...
				{"Important", "Fixates a random player: Run away because this HURTS."},
				{"Important", "Two adds at once will wipe your group so hard focus one down if a second spawns."}}, -- Surgeon Stitchflesh
	[165824] = {{"Important", "Dodge: Death Orbs (silence + dam). Big green balls."},
	...
	[165197] = {{"Important", "Very large tank damage due to stacking debuff. Pop DPS cooldowns and kill quickly."},
				{"Important", "Dodge: blue swirls"}}, -- Skeletal Monstrosity
	...
	[162058] = {{"Important", "The pass fail here is dodging the small black orbs which will knock you up."},
				{"Important", "They'll spawn from rifts the boss leaves behind when he Shadoww whirls. Tank the boss close to rifts."},
	...
	[162059] = {{"Important", "The pass-fail here is whether you dodge the small black missiles fired from Azules"},
	...
	[163524] = {{"Important", "Dodge: Slice-Spell. Random charge on a player."}}, -- Kyrian Dark-Praetor
	[168845] = {{"Important", "Pull one at a time and let debuffs fall off!"},
				{"Important", "Dodge: black swirl (Charged Spear)"}}, -- Astronos
