...
if AL then
	...
	AL["NOTE_159496"] = "Then you will be able to interact with [Madalav's Hummer] to summon him."
	...
	AL["NOTE_160821"] = "In order to summon him you have to use an [Enticing Anima] to light worldedge braziers. This item is dropped by [Encroanting] creatures along the river."
	...
	AL["NOTE_168135_3"] = "Obtain [Cracked Soulweb] (on top of the mountain and underneith the cart)"
	AL["NOTE_168135_4"] = "Complete quest [Outplayed] (giver [Lady of the Falls]). Series of quests starting with [Ages-Echoing Wisdom]"
	AL["NOTE_168135_5"] = "Requires 10x[Lightless Silk]. Repair [Cracked Soulweb] talking to [Elder Gwenna]"
	...
	AL["NOTE_173449"] = "You can use the spell [Door of Shadows] (from [Necrolords] covenant) to reach it, but before you do, take the [Forbbiden Ink] from the bottom floor (on top of a table). You will need the ink to interact with the quill."
	...
	AL["NOTE_180273"] = "In order to get the [Sorrowbane] the world quest [A Few Bumps Along the Way] has to be up!. If it is, then talk to the innkepper at The Theater of Pain and make it your new home. Then buy 1x[Strength of Blood] from Ta'tru (in Ravendreth 51.78), buy 1x[Potion of Unusual Strength], get 2x[Battle Hardened] and collect 4x[Edible Redcap]. Your movement will be reduced a 80%, thats why you have to use your hearthstone back to the Inn, mount up and go as fast as you can to the Sword, drink all the potions and pick up the sword before the buffs go away."
	AL["NOTE_180273_1"] = "Go to Ravendreth [51.78] and buy 1x[Strength of Blood] from Ta'tru"
	...
	AL["NOTE_353324"] = "It appears on the world map whenever is active."
	...
	AL["NOTE_354289"] = "This container is the [Broken flute] part of the achievement. You have to kill [Unsettled Etherwyrm] that are flying near the treasure to loot [Broken Kyrian Flute]. You will use this item to unlock the chest."
	...
	AL["NOTE_355418"] = "Inside the tree. You have to access from the middle. Use the ramp to reach it."
	...
	AL["NOTE_355980"] = "In order to interrupt the ritual, collect [Missing Ritual Pages] and use them on the [Book of Bindings Rituals]. You will get [Ritualist's Knowledge] that allows you to unlock the treasure for 5 minutes. Important! if you die or you don't reach the treasure in 5 minutes, the pages won't respawn until tomorrow!"
	AL["NOTE_355980_1"] = "Get [Missing Ritual Pages] from [Bone Pile]"
	AL["NOTE_355980_2"] = "Book of Bindings Rituals"
	AL["NOTE_356535"] = "You need the [Runespeaker's Key] to open it. The holder of the key is [Runespeaker Phaeton]."
	AL["NOTE_356535_1"] = "Runespeaker Phaeton"
	...
	AL["NOTE_DAFFODIL_NPCS"] = "Talk to [Daffodil] (fairy flying beside). It will make [Rotbriar Changeling] appear to kill him."
	...
	AL["NOTE_HOUSE_CONSTRICTS"] = "House of Constricts"
