	...
	OnEvent = function(self, event,...)--onevent functions and set up
		...
		elseif	(event=="VARIABLES_LOADED") then
			...
			if self.Settings.Character.Language == nil then
				if UnitRace("player") == BRAC["Human"] or UnitRace("player") == BRAC["Kul Tiran"] then
					self.Settings.Character.Language = T_Common--T_Common
				elseif UnitRace("player") ==  BRAC["Orc"] or UnitRace("player") == BRAC["Mag'har Orc"] then
					self.Settings.Character.Language = T_Orcish--T_Orcish
				elseif (UnitRace("player") == BRAC["Blood Elf"] or UnitRace("player") == BRAC["Void Elf"]) then 
				...
				elseif (UnitRace("player") == BRAC["Draenei"] or UnitRace("player") == BRAC["Lightforged Draenei"]) then
					self.Settings.Character.Language = T_Draenei
				elseif (UnitRace("player") == BRAC["Tauren"] or UnitRace("player") == BRAC["Highmountain Tauren"]) then 
					self.Settings.Character.Language = T_Taurahe
				elseif (UnitRace("player") == BRAC["Dwarf"] or UnitRace("player") == BRAC["Dark Iron Dwarf"]) then
				...
				elseif UnitRace("player") == BRAC["Troll"] or UnitRace("player") == BRAC["Zandalari Troll"] then
				...
				elseif UnitRace("player") == BRAC["Nightborne"] then
